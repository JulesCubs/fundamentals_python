# Permite ingresar una línea llena de números y sumarlos fácilmente. Nota: la función input(), combinada junto con las funciones int() o float(), no es lo adecuado para este propósito.
...
while True:
    ...
    if len(linea) > 0 :
        ...
        print("Ingresar un valor adecuado")
strings = linea.split()
total = 0
try:
